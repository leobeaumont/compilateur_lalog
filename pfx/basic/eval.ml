...
(* Question 4.2 + Extensions Question 9.3 / 13.5 *)
...
let step state =
  ...
  (* Division by 0 *)
  | Div :: q, VInt _ :: VInt 0 :: _ ->
      Error("Division by 0", state)

  | Rem :: q, VInt _ :: VInt 0 :: _ ->
      Error("Division by 0", state)
  ...
  (* Sequence: push executable sequence on stack *)
  | Seq cmds :: q, stack ->
